...
const SingerItem = ({ image, name, id }) => {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 mb-1 text-sm text-gray-500">Artist</p>
      <svg
        ...
        className="absolute bottom-[60px] -right-5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out"
      >
        <g id="Calque_1">
